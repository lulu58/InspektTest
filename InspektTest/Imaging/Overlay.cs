...
namespace Visutronik.Imaging
{
    ...
    public class Overlay
    {
        ...
        private string ovlname = "";            // Namen für Debugging...
        ...
        /// </summary>
        /// <param name="bm"></param>
        public void SetOverlay(System.Drawing.Bitmap bm, string name = "")
        {
            Debug.WriteLineIf(UseDebug, "Overlay.SetOverlay(bitmap, name)");
            if (bm == null)
            {
                Debug.WriteLine("Overlay.SetOverlay() ERROR: bm == null!");
                return;
            }
            ovlname = name;
            Debug.WriteLine($"Overlay.SetOverlay(): w={bm.Width}, h={bm.Height}, name = {name}");
        ...
        public void ClearOverlay()
        {
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
            else
            {
        ...
        {
            //Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawText()");
        ...
        public void DrawLabel(string s,
                             ...
                             System.Drawing.Color color)
        {
            //Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawLabel()");
        ...
        {
            //Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawString()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        public void DrawStringCentric(string s,
                             ...
                             System.Drawing.Font font)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawStringCentric()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
                             ...
                             bool at_pt2)
        {
            ...
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawArrow()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        public void DrawLine(System.Drawing.PointF pt1,
                             ...
                             System.Drawing.Color col)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawLine()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        public void DrawCross(System.Drawing.PointF pt,
                             System.Drawing.Color col)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawCross()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        public void DrawCircle(System.Drawing.PointF pt,
                               ...
                               System.Drawing.Color col)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawCircle()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        /// <summary>
        /// draw a circle marker (accessor) to the overlay
        /// </summary>
        /// <param name="pt"></param>
        /// <param name="col"></param>
        /// <exception cref="NullReferenceException"></exception>
        ...
        public void DrawRectangle(System.Drawing.PointF pt1,
                                  ...
                                  System.Drawing.Color col)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawRectangle()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        public void DrawRectangleF(System.Drawing.RectangleF rect,
                          System.Drawing.Color col)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawRectangleF()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        public void DrawRectangle(System.Drawing.Rectangle rect,
                                  ...
                                  System.Drawing.Color col)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawRectangle() with offset");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        public void FillRectangle(System.Drawing.Rectangle rect,
                                  ...
                                  System.Drawing.Color col)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: FillRectangle()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        public void DrawEllipse(System.Drawing.Rectangle rect,
                                ...
                                System.Drawing.Color col)
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: DrawEllipse()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
        ...
        {
            Debug.WriteLineIf(UseDebug, $"overlay{ovlname}: FillEllipse()");
            if (ovlbitmap == null)
            {
                throw new NullReferenceException($"overlay{ovlname}: Bitmap not initialized");
            }
